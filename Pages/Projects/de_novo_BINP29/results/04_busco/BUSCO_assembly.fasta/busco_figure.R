...
# Output
my_output <- paste("results/04_busco/BUSCO_assembly.fasta/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('BUSCO_assembly', 'BUSCO_assembly', 'BUSCO_assembly', 'BUSCO_assembly')
...
my_percentage <- c(97.4, 2.2, 0.1, 0.3)
my_values <- c(2081, 48, 2, 6)
